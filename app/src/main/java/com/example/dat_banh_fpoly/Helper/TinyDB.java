...
public class TinyDB {
    ...
    public ArrayList<IteamsModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<IteamsModel> playerList = new ArrayList<IteamsModel>();

        for (String jObjString : objStrings) {
            IteamsModel player = gson.fromJson(jObjString, IteamsModel.class);
    ...
    public void putListObject(String key, ArrayList<IteamsModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (IteamsModel player : playerList) {
